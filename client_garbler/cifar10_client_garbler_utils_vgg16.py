...
off_client_compute_garble     = 8.7896     # seconds CHANGED
off_client_compute_encode     = 2.295      # seconds CHANGED
off_client_write_garbled_c    = 4859920940 # bytes CHANGED
...
on_client_write_linear   = np.array([27689])
...
on_server_compute_relu   = np.array([1.1166   , 1.5348   , 0, 0.5577935, 0.5597488, 0, 0.2914538, 0.2895338,
                                     0.2863851, 0, 0.1410602, 0.1451064, 0.1416594, 0, 0.0378434, 0.039374 ,
                                     0.0398178, 0, 0.0705095, 0.0721002]) #seconds CHANGED
