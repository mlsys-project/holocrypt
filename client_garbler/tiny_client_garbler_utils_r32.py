...
off_client_compute_garble     = 36.9232      # seconds
off_client_compute_encode     = 8.878599     # seconds
off_client_write_garbled_c    = 20698368320  # bytes
...
on_client_write_linear   = [110633] #bytes
...
on_server_compute_relu   = np.array([1.1638   , 1.1744   , 1.1594   , 1.1564   , 1.1672   , 1.2714   ,
